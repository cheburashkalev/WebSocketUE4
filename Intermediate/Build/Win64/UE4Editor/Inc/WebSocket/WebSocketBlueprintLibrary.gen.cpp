...
static struct FScriptStruct_WebSocket_StaticRegisterNativesFWebSocketHeaderPair
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FWebSocketHeaderPair_Hash() { return 3402744687U; }
	...
	IMPLEMENT_CLASS(UTest, 3964336243);
	...
	IMPLEMENT_CLASS(UTest2, 1167655134);
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UWebSocketBlueprintLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UWebSocketBlueprintLibrary_Connect, "Connect" }, // 3099825432
		{ &Z_Construct_UFunction_UWebSocketBlueprintLibrary_ConnectWithHeader, "ConnectWithHeader" }, // 870279714
		{ &Z_Construct_UFunction_UWebSocketBlueprintLibrary_GetJsonIntField, "GetJsonIntField" }, // 2406734843
		{ &Z_Construct_UFunction_UWebSocketBlueprintLibrary_JsonToObject, "JsonToObject" }, // 3262740718
		{ &Z_Construct_UFunction_UWebSocketBlueprintLibrary_ObjectToJson, "ObjectToJson" }, // 909834493
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UWebSocketBlueprintLibrary, 2902270341);
